...
public class BookLoansDAO extends BaseDAO<BookLoans> {
	...
	public void addBookLoans(Integer bookId, Integer branchId, Integer cardNo, String dateOut, String dueDate) throws SQLException, ClassNotFoundException {
	...
	public void updateBookLoans(Integer bookId, Integer branchId, Integer cardNo, String dateIn) throws SQLException, ClassNotFoundException {
	...
	public void updateBookLoans(Integer bookId, Integer branchId, Integer cardNo, String dateOut, String dueDate) throws SQLException, ClassNotFoundException {
	...
	public List<BookLoans> readBookLoansDue(String currentDateTime) throws ClassNotFoundException, SQLException {
		return read("SELECT * FROM tbl_book_Loans WHERE dueDate < ? AND dateIn IS NULL", new Object[] { currentDateTime });
...
//			bookLoans.setDateIn(dateFormat.format(rs.getString("dateIn")));
//			bookLoans.setDateOut(dateFormat.format(rs.getString("dateOut")));
//			bookLoans.setDueDate(dateFormat.format(rs.getString("dueDate")));
